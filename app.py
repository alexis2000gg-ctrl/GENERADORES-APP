...
with tab3:
    ...
    with st.expander("❄️ **PROCEDIMIENTO PASO A PASO: CAMBIO DE REFRIGERANTE Y PURGADO**", expanded=False):
        st.warning("⚠️ **SEGURIDAD:** ¡NUNCA ABRIR EL TAPÓN DEL RADIADOR O VASO DE EXPANSIÓN CON EL MOTOR CALIENTE! Quemaduras por vapor a alta presión.")
        st.markdown("""
        1. **Drenaje Doble:** Con el motor FRÍO, abrir el grifo/tapón inferior del radiador Y el tapón de vaciado del bloque motor para vaciar el agua retenida en camisas.
        2. **Comprobación de Manguitos:** Revisar grietas, hinchazones o abrazaderas flojas en los manguitos de radiador e intercooler.
        3. **Tipo de Líquido:** Usar exclusivamente **Anticongelante Orgánico 50%** (Volvo VCS, CAT ELC, etc. según especifique la Ficha Técnica). *¡Prohibido usar agua de grifo!*
        4. **Llenado Lento:** Verter el refrigerante muy poco a poco por el depósito/radiador para dejar salir el aire atrapado en la culata.
        5. **Purgado de Bolsas de Aire:**
           * Arrancar el grupo en MANUAL con el tapón abierto.
           * Dejar funcionar hasta que el motor alcance la temperatura de trabajo (~80-85°C) y abra el termostato.
           * Al abrir el termostato el nivel bajará rápidamente: rellenar inmediatamente hasta la marca MAX.
        6. **Cierre y Verificación:** Colocar el tapón, dejar enfriar completamente y hacer la lectura final de nivel.
        """)
